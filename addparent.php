...
<head> <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="navbar">
		...
		<label>Parent Address:</label>
			...
			<input type="text" name="Telephone"> <input type="submit" name="submit">
...
on the database
*/
					 $sql = "INSERT INTO parents ( ParentName,ParentAddress,Email,Telephone) VALUES ( '$ParentName', '$ParentAddress', '$Email', '$Telephone')";
