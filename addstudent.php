...
<head> <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="navbar">
		...
		<form method="post" action="addstudent.php">
			...
			<label>Student Medical Info:</label>
...
*/
			...
			$sql = "INSERT INTO student (StudentName,Stud_address,Medical_Info,ClassesID) VALUES ('$StudentName','$Stud_address','$Medical_Info','$ClassesID')";
