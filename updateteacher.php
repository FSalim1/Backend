...
<head> <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div class="navbar">
		...
		<form method="post" action="updateteacher.php">
			...
			<br><label>Teacher Medical Info:</label>
			<input type="text" name="TeacherMedInfo">
			
			<br><label>Teacher Phone Number:</label>
			<input type="text" name="TeacherPhone">
            
            <br><label>Teacher Salary:</label>
			<input type="text" name="Salary">

            <br><label>Teacher Background:</label>
...
*/
		if (isset($_POST['submit'])) {
            ...
            $TeacherMedInfo = $_POST['TeacherMedInfo'];
            ...
            /*
					...
					on the database
					*/
			$sql = "UPDATE teacher SET TeacherName = '$TeacherName', TeacherAddress= '$TeacherAddress',TeacherMedInfo= '$TeacherMedInfo', TeacherPhone='$TeacherPhone', Salary='$Salary', Background='$Background' WHERE TeacherID='$TeacherID'";
