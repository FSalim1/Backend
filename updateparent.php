...
*/
		...
		if (isset($_POST['submit'])) {
			...
			/*
					...
					on the database
					*/
			$sql = "UPDATE parents SET ParentName = '$ParentName', Email= '$Email',ParentAddress= '$ParentAddress', ParentID='$ParentID' WHERE ParentID='$ParentID'";
