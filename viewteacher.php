    ...
    <div class="navbar">
		...
		<table>
			...
			<tr>
                ...
                <th width="250px">TeacherMedInfo<br><hr></th>
                <th width="250px">TeacherPhone<br><hr></th>
			...
			<?php
			$sql = mysqli_query($link, "SELECT TeacherID, TeacherName,TeacherAddress,TeacherMedInfo,TeacherPhone,Salary,Background,ClassesID FROM teacher");
